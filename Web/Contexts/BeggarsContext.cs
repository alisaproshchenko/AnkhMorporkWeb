...
namespace Web.Contexts
{
    public class BeggarsContext : DbContext
    {
        ...
        public BeggarsContext()
        {
            Database.EnsureCreated();
        }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=.;Database=AnkhMorporkDB.Beggars;Trusted_Connection=True;");
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Beggar>().HasData(new[]
            {
                ...
                new Beggar{Id = 9, Name = "Someone Who Needs Eightpence For A Meal", Fee = 0.08m,
                ...
                new Beggar{Id = 10, Name = "Someone Who Needs Tuppence For A Cup Of Tea", Fee = 0.02m,
